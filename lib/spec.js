...
const {  NodeWithChildren, Node, Document, LineNode, AbsLineNode, WrapLineNode, AbsWrapLineNode, WrapNode, AbsWrapNode } = require('./node')
...
module.exports = { VisibilityType, MethodInfo, NodeWithChildren, Node, Document, LineNode, AbsLineNode, WrapLineNode, AbsWrapLineNode, WrapNode, AbsWrapNode, Language, ClassSpec, PropertyInfo }