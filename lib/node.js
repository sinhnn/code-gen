 ...
 * @brief line with relative indent level
 */
class AbsLineNode extends TextNode {
    _level = 0;
...
module.exports = {  NodeWithChildren, Node, Document, LineNode, AbsLineNode, WrapLineNode, AbsWrapLineNode, WrapNode, AbsWrapNode }